                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                                <div class="room">
                                    <a href="rooms-single.html" class="img d-flex justify-content-center align-items-center" v-bind:style="{'background-image': 'url(/frontend/images/room-2.jpg)'}">
                                        <div class="icon d-flex justify-content-center align-items-center">
                                            <span class="icon-search2"></span>
                                        </div>
                                    </a>
                            ...
                            <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                                <div class="room">
                                    <a href="rooms-single.html" class="img d-flex justify-content-center align-items-center" v-bind:style="{'background-image': 'url(/frontend/images/room-3.jpg)'}">
                                        <div class="icon d-flex justify-content-center align-items-center">
                                            <span class="icon-search2"></span>
                                        </div>
                                    </a>
                            ...
                            <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                                <div class="room">
                                    <a href="rooms-single.html" class="img d-flex justify-content-center align-items-center" v-bind:style="{'background-image': 'url(/frontend/images/room-4.jpg)'}">
                                        <div class="icon d-flex justify-content-center align-items-center">
                                            <span class="icon-search2"></span>
                                        </div>
                                    </a>
                            ...
                            <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                                <div class="room">
                                    <a href="rooms-single.html" class="img d-flex justify-content-center align-items-center" v-bind:style="{'background-image': 'url(/frontend/images/room-5.jpg)'}">
                                        <div class="icon d-flex justify-content-center align-items-center">
                                            <span class="icon-search2"></span>
                                        </div>
                                    </a>
                            ...
                            <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                                <div class="room">
                                    <a href="rooms-single.html" class="img d-flex justify-content-center align-items-center" v-bind:style="{'background-image': 'url(/frontend/images/room-6.jpg)'}">
                                        <div class="icon d-flex justify-content-center align-items-center">
                                            <span class="icon-search2"></span>
                                        </div>
                                    </a>
