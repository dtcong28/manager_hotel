    ...
    <WebLayout>
        ...
        <section class="ftco-booking">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <form @submit.prevent="filterRoom" class="booking-form">
                            <div class="row">
                                <div class="col-md-3 d-flex">
                                    <div class="form-group p-4 align-self-stretch d-flex align-items-end">
                                        <div class="wrap">
                                            <label>Check-in Date</label>
                                            <input type="date" v-model="form.check_in" name="check_in" class="form-control" placeholder="Check-in date">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 d-flex">
                                    <div class="form-group p-4 align-self-stretch d-flex align-items-end">
                                        <div class="wrap">
                                            ...
                                            <input type="date" name="check_out" v-model="form.check_out" class="form-control" placeholder="Check-out date">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="wrap">
                                            ...
                                            <div class="form-field">
                                                <div class="select-wrap">
                                                    ...
                                                    <select name="number_room" v-model="form.number_room" class="form-control">
                                ...
                                <div class="col-md d-flex" v-for="room in form.number_room" :key="room">
                                    <div class="form-group p-4 align-self-stretch d-flex align-items-end">
                                        <div class="wrap">
                                            ...
                                            <div class="form-field">
                                                <div class="select-wrap" >
                                                    <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                                                    <select name="number_people" v-model="form.room[room]" class="form-control">
